configurations { "Debug", "Release", "Debug_MT", "Release_MT", "TRACE", "TRACE_MT" }
    ...
    filter { "platforms:Win32", "configurations:not *_MT" }
        ...
        libdirs 
        {
            ...
            "bin/x86/%{_ACTION}/md",
            "%{BOOK_CODE_PATH}/lib/x86/%{_ACTION}/md"
        }
    ...
    filter { "platforms:Win32", "configurations:*_MT" }
        ...
        libdirs 
        {
            ...
            "bin/x86/%{_ACTION}/mt",
            "%{BOOK_CODE_PATH}/lib/x86/%{_ACTION}/mt"
        }    
    ...
    filter { "platforms:x64", "configurations:not *_MT" }
        ...
        {
            --"lib/v7.1/Lib/x64",
            "H:/rover/rover-self-work/cpp/boost_1_66_0/stage/x64/lib",
            "%{WORK_PATH}/lib/x64/%{_ACTION}/md",            
            "%{WORK_PATH}/bin/x64/%{_ACTION}/md",
            "lib/x64/%{_ACTION}/md",
            "lib/x64/%{_ACTION}/md/boost-1_60",
            "bin/x64/%{_ACTION}/md",
            "%{BOOK_CODE_PATH}/lib/x64/%{_ACTION}/md"
        }
    ...
    filter { "platforms:x64", "configurations:*_MT" }
        ...
        libdirs
        {
            ...
            "bin/x64/%{_ACTION}/mt",
            "%{BOOK_CODE_PATH}/lib/x64/%{_ACTION}/mt",
        }
